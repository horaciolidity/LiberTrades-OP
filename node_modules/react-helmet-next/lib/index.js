...
// src/Provider.tsx
var defaultValue = {};
var Context = import_react.default.createContext(defaultValue);
var HelmetProvider = class _HelmetProvider extends import_react.Component {
  ...
  render() {
    return /* @__PURE__ */ import_react.default.createElement(Context.Provider, { value: this.helmetData.value }, this.props.children);
  }
};
...
// src/Dispatcher.tsx
var HelmetDispatcher = class extends import_react2.Component {
  rendered = false;
...
// src/index.tsx
var Helmet = class extends import_react3.Component {
  static defaultProps = {
    defer: true,
    encodeSpecialCharacters: true,
