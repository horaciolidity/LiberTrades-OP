...
const Dashboard = () => {
  ...
  const stats = [
    { title: 'Saldo Total', value: `${(user?.balance || 0).toFixed(2)}`, icon: Wallet, color: 'text-green-400', bgColor: 'bg-green-500/10' },
    { title: 'Total Invertido', value: `${totalInvested.toFixed(2)}`, icon: DollarSign, color: 'text-blue-400', bgColor: 'bg-blue-500/10' },
    { title: 'Ganancias', value: `${totalEarnings.toFixed(2)}`, icon: TrendingUp, color: 'text-purple-400', bgColor: 'bg-purple-500/10' },
    { title: 'Referidos', value: referrals.length.toString(), icon: Users, color: 'text-orange-400', bgColor: 'bg-orange-500/10' }
  ];
